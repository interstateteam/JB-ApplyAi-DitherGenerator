	...
	if ( coord.x >= 1.0 ) {
		...
		void main() {
			...
			gl_FragColor = mix( outputColor, texel, alpha );
				...
				}`})}};wl.BlurDirectionX=new K(1,0),wl.BlurDirectionY=new K(0,1);function Tl(e,t,n){let r=new xl(e),i=new Sl(t,n);r.addPass(i);let a=new wl(new K(window.innerWidth,window.innerHeight),3.5,2,1);return r.addPass(a),window.addEventListener(`resize`,()=>{r.setSize(window.innerWidth,window.innerHeight)}),r}var El,Dl,Ol,kl,Al=!1;function jl(e){Al=e,kl&&(kl.autoRotate=!e)}var Ml={x:0,y:0,z:1e3},Nl=1,Pl={x:0,y:0,z:500};function Fl(e){let t=document.getElementById(e);if(!t)return;El=new jn,El.background=null,Dl=new aa(window.innerWidth/-2,window.innerWidth/2,window.innerHeight/2,window.innerHeight/-2,1,1e3),Dl.position.set(Ml.x,Ml.y,Ml.z),Dl.zoom=Nl,Dl.updateProjectionMatrix(),Ol=new Wc({canvas:t,antialias:!0,alpha:!0}),Ol.setSize(window.innerWidth,window.innerHeight),Ol.setClearColor(0,0),kl=new el(Dl,Ol.domElement),kl.target.set(Pl.x,Pl.y,Pl.z),kl.enableDamping=!0,kl.dampingFactor=.5,kl.autoRotate=!0,kl.autoRotateSpeed=5,kl.saveState();let n=new Ir({});n.color.setRGB(0,0,0),Tl(Ol,El,Dl);function r(){requestAnimationFrame(r),kl&&kl.update(),Ol.render(El,Dl)}return r(),window.addEventListener(`resize`,()=>{let e=window.innerWidth,t=window.innerHeight;Dl.left=e/-2,Dl.right=e/2,Dl.top=t/2,Dl.bottom=t/-2,Dl.updateProjectionMatrix(),Ol.setSize(e,t)}),{material:n}}function Il(){!Dl||!kl||(jl(!0),kl.reset())}var Ll=document.createElement(`canvas`),Rl=Ll.getContext(`2d`);function zl(e,t,n){return Ll.width=t,Ll.height=n,Rl.drawImage(e,0,0,t,n),Rl.getImageData(0,0,t,n)}function Bl(e){let t=1,n=0;for(let r=0;r<e.data.length;r+=4)if(e.data[r+3]/255>0){let i=.299*(e.data[r]/255)+.587*(e.data[r+1]/255)+.114*(e.data[r+2]/255);i<t&&(t=i),i>n&&(n=i)}return n===t&&(n+=.001),{minBright:t,maxBright:n}}function Vl(e,t){let n=window.innerWidth,r=window.innerHeight,i=Math.floor(n/t),a=Math.floor(r/t);if(!e)return{cols:i,rows:a};let o=e.width/e.height;return o>n/r?{cols:i,rows:Math.floor(i/o)}:{cols:Math.floor(a*o),rows:a}}var Hl=new Sn,Ul=new X,Wl,Gl;function Kl(e,t,n){if(!El)return;Gl&&(El.remove(Gl),Gl.dispose()),Wl&&Wl.dispose();let{pixelAmount:r,pixelScale:i,gridScale:a,pixelDistortion:o,gravityScale:s}=t,c=o?o/100:0;Wl=new xi(2,2);let l=Wl.attributes.position,u=new q;for(let e=0;e<l.count;e++){u.fromBufferAttribute(l,e);let t=1+(Math.sin(u.x*4)+Math.cos(u.y*3.6)+Math.sin(u.z*5.8))*.3*c;u.multiplyScalar(t),l.setXYZ(e,u.x,u.y,u.z)}Wl.computeVertexNormals();let{cols:d,rows:f}=Vl(e,r),p=d*f;if(p<=0)return;let m=e?zl(e,d,f):null,{minBright:h,maxBright:g}=m?Bl(m):{};Gl=new oi(Wl,n,p),Gl.scale.setScalar(10/10);let _=0;for(let e=0;e<d;e++)for(let t=0;t<f;t++){let n=(e-(d-1)/2)*r,a=(t-(f-1)/2)*r;Hl.position.set(n,a,0),Hl.rotation.set(Tt.randInt(0,365),Tt.randInt(0,365),Tt.randInt(0,365));let o=i/50,s=1,l=1,u=1,p=1;if(m){let n=((f-1-t)*d+e)*4,r=m.data[n]/255,i=m.data[n+1]/255,a=m.data[n+2]/255,v=m.data[n+3]/255;if(p=.299*r+.587*i+.114*a,p=(p-h)/(g-h),p=Math.max(0,Math.min(1,p)),v<=.01)o=0;else{let e=.2+(1-p)*1.2;o*=e;let t=.5*c,n=.4*c;o*=Tt.randFloat(1-t/2,1+t/2),s=Tt.randFloat(1-n/2,1+n/2),l=Tt.randFloat(1-n/2,1+n/2),u=Tt.randFloat(1-n/2,1+n/2)}Ul.setRGB(p,p,p),Gl.setColorAt(_,Ul)}else Ul.setHex(0),Gl.setColorAt(_,Ul);Hl.scale.set(o*s,o*l,o*u),Hl.position.z=p*1200,Hl.updateMatrix(),Gl.setMatrixAt(_,Hl.matrix),_++}m&&(Gl.instanceColor.needsUpdate=!0),El.add(Gl)}var ql={xmlns:`http://www.w3.org/2000/svg`,width:24,height:24,viewBox:`0 0 24 24`,fill:`none`,stroke:`currentColor`,"stroke-width":2,"stroke-linecap":`round`,"stroke-linejoin":`round`},Jl=([e,t,n])=>{let r=document.createElementNS(`http://www.w3.org/2000/svg`,e);return Object.keys(t).forEach(e=>{r.setAttribute(e,String(t[e]))}),n?.length&&n.forEach(e=>{let t=Jl(e);r.appendChild(t)}),r},Yl=(e,t={})=>Jl([`svg`,{...ql,...t},e]),Xl=e=>{for(let t in e)if(t.startsWith(`aria-`)||t===`role`||t===`title`)return!0;return!1},Zl=(...e)=>e.filter((e,t,n)=>!!e&&e.trim()!==``&&n.indexOf(e)===t).join(` `).trim(),Ql=e=>e.replace(/^([A-Z])|[\s-_]+(\w)/g,(e,t,n)=>n?n.toUpperCase():t.toLowerCase()),$l=e=>{let t=Ql(e);return t.charAt(0).toUpperCase()+t.slice(1)},eu=e=>Array.from(e.attributes).reduce((e,t)=>(e[t.name]=t.value,e),{}),tu=e=>typeof e==`string`?e:!e||!e.class?``:e.class&&typeof e.class==`string`?e.class.split(` `):e.class&&Array.isArray(e.class)?e.class:``,nu=(e,{nameAttr:t,icons:n,attrs:r})=>{let i=e.getAttribute(t);if(i==null)return;let a=n[$l(i)];if(!a)return console.warn(`${e.outerHTML} icon name was not found in the provided icons object.`);let o=eu(e),s=Xl(o)?{}:{"aria-hidden":`true`},c={...ql,"data-lucide":i,...s,...r,...o},l=tu(o),u=tu(r),d=Zl(`lucide`,`lucide-${i}`,...l,...u);d&&Object.assign(c,{class:d});let f=Yl(a,c);return e.parentNode?.replaceChild(f,e)},ru=[[`path`,{d:`M14.564 14.558a3 3 0 1 1-4.122-4.121`}],[`path`,{d:`m2 2 20 20`}],[`path`,{d:`M20 20H4a2 2 0 0 1-2-2V9a2 2 0 0 1 2-2h1.997a2 2 0 0 0 .819-.175`}],[`path`,{d:`M9.695 4.024A2 2 0 0 1 10.004 4h3.993a2 2 0 0 1 1.76 1.05l.486.9A2 2 0 0 0 18.003 7H20a2 2 0 0 1 2 2v7.344`}]],iu=[[`path`,{d:`m6 9 6 6 6-6`}]],au=[[`circle`,{cx:`12`,cy:`12`,r:`3`}],[`path`,{d:`M3 7V5a2 2 0 0 1 2-2h2`}],[`path`,{d:`M17 3h2a2 2 0 0 1 2 2v2`}],[`path`,{d:`M21 17v2a2 2 0 0 1-2 2h-2`}],[`path`,{d:`M7 21H5a2 2 0 0 1-2-2v-2`}]],ou=[[`path`,{d:`M10.3 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10l-3.1-3.1a2 2 0 0 0-2.814.014L6 21`}],[`path`,{d:`m14 19.5 3-3 3 3`}],[`path`,{d:`M17 22v-5.5`}],[`circle`,{cx:`9`,cy:`9`,r:`2`}]],su=[[`path`,{d:`M14 11a2 2 0 1 1-4 0 4 4 0 0 1 8 0 6 6 0 0 1-12 0 8 8 0 0 1 16 0 10 10 0 1 1-20 0 11.93 11.93 0 0 1 2.42-7.22 2 2 0 1 1 3.16 2.44`}]],cu=[[`path`,{d:`M10.66 6H14a2 2 0 0 1 2 2v2.5l5.248-3.062A.5.5 0 0 1 22 7.87v8.196`}],[`path`,{d:`M16 16a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h2`}],[`path`,{d:`m2 2 20 20`}]],lu=({icons:e={},nameAttr:t=`data-lucide`,attrs:n={},root:r=document,inTemplates:i}={})=>{if(!Object.values(e).length)throw Error(`Please provide an icons object.
If you want to use all the icons you can import it like:
 \`import { createIcons, icons } from 'lucide';
lucide.createIcons({icons});\``);if(r===void 0)throw Error("`createIcons()` only works in a browser environment.");if(Array.from(r.querySelectorAll(`[${t}]`)).forEach(r=>nu(r,{nameAttr:t,icons:e,attrs:n})),i&&Array.from(r.querySelectorAll(`template`)).forEach(r=>lu({icons:e,nameAttr:t,attrs:n,root:r.content,inTemplates:i})),t===`data-lucide`){let t=r.querySelectorAll(`[icon-name]`);t.length>0&&(console.warn(`[Lucide] Some icons were found with the now deprecated icon-name attribute. These will still be replaced for backwards compatibility, but will no longer be supported in v1.0 and you should switch to data-lucide`),Array.from(t).forEach(t=>nu(t,{nameAttr:`icon-name`,icons:e,attrs:n})))}},uu={pixelAmount:{id:`pixelAmount`,min:80,max:10},pixelScale:{id:`pixelScale`,min:0,max:200},gridScale:{id:`gridScale`,min:2,max:10},pixelDistortion:{id:`pixelDistortion`,min:0,max:30},gravityScale:{id:`gravityScale`,min:0,max:30}},du,fu=null;document.getElementById(`rotationAnimation`).addEventListener(`click`,()=>{jl(!Al)});var pu=()=>Object.fromEntries(Object.entries(uu).map(([e,{id:t,min:n,max:r}])=>{let i=parseInt(document.getElementById(t).value)||0;return[e,Math.floor(n+i/100*(r-n))]})),mu=e=>{let t=new Image;t.onload=()=>{du=t,hu()},t.src=e},hu=()=>Kl(du,pu(),fu);window.addEventListener(`load`,()=>{({material:fu}=Fl(`canvas`)),Object.values(uu).forEach(({id:e})=>document.getElementById(e).addEventListener(`input`,hu)),document.getElementById(`pickImage`).addEventListener(`change`,e=>{e.target.files[0]&&mu(URL.createObjectURL(e.target.files[0]))}),document.getElementById(`focusCamera`).addEventListener(`click`,Il);let e=document.getElementById(`defaultImage`);e&&(mu(e.src),hu()),lu({icons:{ImageUp:ou,Shell:su,Focus:au,CameraOff:ru,VideoOff:cu,ChevronDown:iu}})});